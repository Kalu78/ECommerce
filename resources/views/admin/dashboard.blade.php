        ...
        <!-- Section heading -->
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <!-- Card -->
                    <a href="/admin/allProduct" class="card hoverable">
                        
                        <!-- Card content -->
                        <div class="card-body my-4">

                        <h2><i class="cogs icon text-muted"></i></h2>
                        <h5 class="black-text mb-0">Éditer les produits</h5>
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <!-- Card -->
                    <a href="/admin/allUser" class="card hoverable">
                        
                        <!-- Card content -->
                        <div class="card-body my-4">

                        <h2><i class="cogs icon text-muted"></i></h2>
                        <h5 class="black-text mb-0">Éditer les informations des utilisateus</h5>
